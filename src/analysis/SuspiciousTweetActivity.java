...
/**
 * Gathers all the original tweets and retweets made by followed suspicious 
 * users and prints out the texts in a per-user text file.
 * 
 * @author Sokratis Papadopoulos
 */
public class SuspiciousTweetActivity {
